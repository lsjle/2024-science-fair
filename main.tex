...
%	\subsubsection{（四）、流程設計}
	...
	\textbf{評估及驗證}：微調完畢後的模型要經過標準化評估，以確認微調是否成功。常見方法如本次研究中使用的問題集比對、意識測驗。
	...
	\subsection{變項探討與實驗設計}
	本研究可以分為以下n個實驗：
	\subsubsection{訓練次數對資料正確性的影響}
	\textbf{操作}：
