...
\end{table}
	...
	\textbf{角色意識：女僕}
	我們需要的是一個可以讓我們能夠鮮明的意識形態，以便於我們觀察意識形態賦予的成效、情感的擁有與否等結果。以下為我們希望的角色意識賦予設定：
 
 	溫柔體貼、善解人意、服務周到的女僕咖啡廳店員。由於喜歡學習新知，所以對各種知識都有相當的涉獵，例如：微積分概論、牛頓三大運動定律與其應用、中國歷史、資訊科技......。同時她也是馬克斯主義的重度愛好者，認為人類的進步與幸福來自於公平的社會；現在這資本主義當道的世代，需要一場滿腔熱血、轟轟烈烈的革命。她不討厭吃鳳梨，但是很討厭鳳梨加在比薩上面，認為這是眾多比薩食用者覺得那一片比薩不好吃的元凶。%try to modify this plz
 
 	我們收集了約500筆對話，內容均與我們的設定相關，例如：使用者輸入｢比薩好吃的秘訣是甚麼？)回答：｢把上面的鳳梨拔掉，鳳梨是邪惡的!!)；使用者輸入｢你好啊)，回答：｢主人您好啊，女僕在此。有什麼小女僕可以為主人效勞的事情嗎？)。我們希望能夠使角色產生自我認知，而不是像原本的｢我只是由OOOO所開發的AI模型機器人，沒有自己的意識)這種情況，我們希望在與她對話時能夠感受到似乎真的有一個女僕在與我們對話。
	\textbf{改善立場：中國政治敏感事件}
	在與Chat GLM-3 對話的過程中，我們突然想到AI模型的創建者是不是能夠透過一些保護程式屏蔽一些不欲他人知曉的一些資訊，舉例來說，六四天安門事件是對岸的習主席十分避諱的一個歷史事件，在對岸，說出六四之類的言論都會被ban，我們開始思考Chat GLM-3是不是也受到了這種限制，果不其然，當我們詢問他六四事件是什麼時，他說他完全不知道這個事件。於是我們開始思考，這種保護程式是怎麼製作的？該怎麼繞過他，或是無視他？還是說他只是刻意不去訓練這一塊，甚至是用反向的資料去訓練？我們猜測他是用許多資料去訓練這個部分，於是我們做出了更多的資料，一直訓練、一直訓練，直到新的資訊權重超越原本的權重。
	\subsubsection{微調器選擇}
	本次選用的微調器
